...
- Main homepage branch is PR-ready `main` (`upstream-sync` / `main` / `exp/*` split).
- SDXL 1024 fast response is presented in `s/it` with real phone gallery outputs.
- Reproducible benchmark reporting at `benchmarks/results/benchmark_results.csv`.
- Benchmark image assets and metadata are kept at `benchmarks/images/`.
...
### SDXL 1024 Real Device Showcase (Local Dream App)

All samples below are generated by **local dream** on phone package:
`io.github.xororz.localdream`.

Source of speed/config labels:
- `files/history/sdxl/*.json` from device via `adb shell run-as io.github.xororz.localdream cat ...`
- Speed unit: `s/it = generationTime / steps`
- Milestone memory baseline: around `~1.4 s/it (CFG on)`; recent saved runs are `~1.64-1.74 s/it`

![SDXL sample 2026-01-22 17:25:19](benchmarks/images/localdream_sdxl_1769073919488.png)
Device: `2410DPN6CC (SM8750, HyperOS 3.0.7.0, v79 path)`
Speed: `1.64 s/it` (`32.8s / 20 steps`, `CFG=7`)
Config: `SDXL`, `1024x1024`, `20 steps`, `Euler`, `CFG=7`, `seed=3332264532`

![SDXL sample 2026-01-22 17:26:30](benchmarks/images/localdream_sdxl_1769073990211.png)
Device: `2410DPN6CC (SM8750, HyperOS 3.0.7.0, v79 path)`
Speed: `1.64 s/it` (`32.8s / 20 steps`, `CFG=7`)
Config: `SDXL`, `1024x1024`, `20 steps`, `Euler`, `CFG=7`, `seed=2861933997`

![SDXL sample 2026-01-23 18:19:23](benchmarks/images/localdream_sdxl_1769163563122.png)
Device: `2410DPN6CC (SM8750, HyperOS 3.0.7.0, v79 path)`
Speed: `1.74 s/it` (`34.8s / 20 steps`, `CFG=7`)
Config: `SDXL`, `1024x1024`, `20 steps`, `Euler`, `CFG=7`, `seed=708751669`
