...
> [!NOTE]
> Upstream mainline focuses on SD1.5. This fork milestone adds SDXL 512/1024 NPU validation on v79 devices (see "Fork Milestone" section below).
>
...
## Adreno + NPU Fork Milestone (happyyzy)

> [!IMPORTANT]
> This section is **fork-only** work (not an upstream feature claim).
...
- Benchmark method and outputs: `docs/performance/methodology.md`, `benchmarks/results/benchmark_results.csv`
